...
\begin{document}
	...
	\todo[inline]{Show that the minimizer $w$ is global. We need to show that the Hessian of $g_\sigma$ is positive semi-definite. This is equivalent with convexity (as $g_\sigma$ is twice differentiable). Then, for a differentiable convex function $g$, $w^*$ is a global minimizer iff $\nabla f(w^*)=0$. Or maybe we can just show convexity directly from definition.}
